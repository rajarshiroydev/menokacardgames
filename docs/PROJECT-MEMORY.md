...
- Step 3A inventory is in `docs/HISTORICAL-OWNERSHIP.md`: 28 sessions and 13 player records from the isolated Neon branch, grouped into 13 unassigned review cohorts. Do not implement a backfill or infer ownership until the user explicitly maps these cohorts. Production was not queried or changed.
