...
- The multi-user version, the Scoreboard redesign and the live standings link are live (2026-09-25); work happens on `main`, one reviewed step at a time. The friend network (user codes, friend requests, group standings) is live too (2026-09-25, `244611c`). Update `docs/HANDOFF.md` at the end of each session.
